      ...
      <section className="public-section">
        ...
        <div className="public-stack-grid">
          <article className="public-story-card">
            ...
            <a href="https://docs.nerior.store" className="public-inline-link">Перейти в docs</a>
          </article>
          <article className="public-story-card">
            <h2>API</h2>
            <p>Отдельный авторизованный кабинет ключей и доступов для продуктов Nerior.</p>
            <a href="https://api.nerior.store" className="public-inline-link">Открыть API</a>
          </article>
          <article className="public-story-card">
            <h2>Сообщество</h2>
            <p>Публичная зона обсуждений, материалов и обновлений для внешней аудитории.</p>
            <a href="https://community.nerior.store" className="public-inline-link">Открыть сообщество</a>
          </article>
        </div>
      </section>
    </main>
