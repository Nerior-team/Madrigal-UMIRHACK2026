...
from app.domains.access.schemas import MachineAccessEntryRead, MachineRoleUpdateRequest, MessageResponse
...
def list_machine_access(
    ...
    return AccessService(access_repository, machine_repository).list_access(
...
def update_machine_access_role(
    ...
    return AccessService(access_repository, machine_repository).update_role(
        machine_id=machine_id,
        access_id=access_id,
...
def revoke_machine_access(
    ...
    return AccessService(access_repository, machine_repository).revoke_access(
        machine_id=machine_id,
        access_id=access_id,
        actor_user=current_user,
        client=client,
